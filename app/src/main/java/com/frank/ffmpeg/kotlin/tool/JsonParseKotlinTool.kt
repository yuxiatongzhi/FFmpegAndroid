package com.frank.ffmpeg.kotlin.tool

import android.text.TextUtils
import android.util.Log
import com.frank.ffmpeg.kotlin.model.AudioKotlinBean
import com.frank.ffmpeg.kotlin.model.MediaKotlinBean
import com.frank.ffmpeg.kotlin.model.VideoKotlinBean
...
class JsonParseKotlinTool {
    ...
    companion object {
        ...
        fun parseMediaFormat(mediaFormat: String?): MediaKotlinBean? {
                ...
                for (index in 0 until jsonMediaStream.length()) {
                    ...
                    if (codecType == TYPE_VIDEO) {
                        ...
                        if (!TextUtils.isEmpty(frameRateStr)) {
                            ...
                            val frameRate = ceil(Double.valueOf(frameRateArray[0]) / Double.valueOf(frameRateArray[1]))
                            Log.e(TAG, "frameRate=" + frameRate.toInt())
                            videoBean.frameRate = frameRate.toInt()
                        }
                    } else if (codecType == TYPE_AUDIO) {
                        val audioBean = AudioKotlinBean()
        ...
        fun stringFormat(mediaBean: MediaKotlinBean?): String? {
            if (mediaBean == null) {
                return null
            }
